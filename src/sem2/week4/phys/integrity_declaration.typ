...
#grid(
  columns: (auto, auto),
  gutter: 0.6em,
  checkbox(checked: false), [No AI tools were used for this assignment],
)
#grid(
  columns: (auto, auto),
  gutter: 0.6em,
  checkbox(checked: true), [AI tools were used as described below:],
)
...
#grid(
  ...
  gutter: 0.6em,
  checkbox(), [Mathematical calculations], checkbox(), [Problem solving], checkbox(checked: true), [Code generation],
)
#grid(
...
#grid(
  columns: (auto, auto),
  gutter: 0.6em,
  checkbox(checked: true), [Shared link: https://claude.ai/share/4429d3b8-b72d-43a8-8b8a-eb6b0fe96234],
)
